 ...
 */
@Controller
@RequestMapping(value = "admin/visits/visitAttributeType.list")
public class VisitAttributeTypeListController {

	private static final String FORM_VIEW = "/admin/visits/visitAttributeTypeList";
	 ...
	 */
	@ModelAttribute("visitAttributeTypeList")
	protected Object formBackingObject() {

		// default empty Object
		List<VisitAttributeType> visitAttributeTypeList = new Vector<>();
