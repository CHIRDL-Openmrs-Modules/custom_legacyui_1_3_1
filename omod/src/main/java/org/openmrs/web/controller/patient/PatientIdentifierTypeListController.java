...
@Controller
@RequestMapping(value = "admin/patients/patientIdentifierType.list")
public class PatientIdentifierTypeListController {

	private static final String FORM_VIEW = "/module/legacyui/admin/patients/patientIdentifierTypeList";
	 ...
	 */
	@ModelAttribute("patientIdentifierTypeList")
	protected Object formBackingObject() {

		// default empty Object
		List<PatientIdentifierType> identifierTypeList = new Vector<>();
