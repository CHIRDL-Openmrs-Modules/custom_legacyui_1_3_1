...
@Controller
@RequestMapping(value = "admin/locations/location.list")
public class LocationListController {

	private static final String FORM_VIEW = "/module/legacyui/admin/locations/locationList";
	...
	protected ModelAndView processSubmit(HttpServletRequest request) throws Exception {
		...
		if (Context.isAuthenticated()) {
			...
			if (locationList != null) {
				...
				String notDeleted = mss.getMessage("Location.cannot.delete");
				...
				error = mss.getMessage("Location.select");
			}
	...
	/**
	 * Logs a location delete data integrity violation exception and returns a user
	...
	protected Object formBackingObject() {
		...
		List<Location> locationList = new Vector<>();
